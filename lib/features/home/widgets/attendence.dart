...
class GetAttendence extends StatefulWidget {
  const GetAttendence({Key? key}) : super(key: key);

  @override
  State<GetAttendence> createState() => _GetAttendenceState();
}

class _GetAttendenceState extends State<GetAttendence> {
  bool intime = false;
  bool outtime = false;
                      ...
                      decoration: BoxDecoration(
                        ...
                        child:Column(
                          ...
                          children: [
                            ...
                            Container(
                              height: 70,
                              child: Image.asset("assets/images/thumb.png",color: Colors.green.shade700,)
                            ),
                      ...
                      child: Container(
                        ...
                        child:Column(
                          ...
                          children: [
                            ...
                            Container(
                                height: 70,
                                child: Image.asset("assets/images/thumb.png",color: Colors.red.shade700,)
                            ),
                            SizedBox(height: 20.0,),
                            Text('Punch Out',
