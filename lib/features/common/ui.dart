...
class Ui {
  static GetSnackBar SuccessSnackBar({String title = 'Success', String ? message}) {
    ...
    return GetSnackBar(
      titleText: Text(title.tr, style: Get.textTheme.headline6!.merge(TextStyle(color: page))),
      messageText: Text(message!, style: Get.textTheme.caption!.merge(TextStyle(color: page))),
      snackPosition: SnackPosition.BOTTOM,
      margin: EdgeInsets.all(20),
      backgroundColor: Colors.green,
      icon: Icon(Icons.check_circle_outline, size: 32, color: page),
  ...
  static GetSnackBar DownloadSnackBar({String title = 'Downloading Started', String ? message}) {
    Get.log("[$title] $message");
    return GetSnackBar(
      titleText: Text(title.tr, style: Get.textTheme.headline6!.merge(TextStyle(color: page))),
      messageText: Text(message!, style: Get.textTheme.caption!.merge(TextStyle(color: page))),
      ...
      margin: EdgeInsets.all(20),
      backgroundColor: Colors.green,
      icon: Icon(Icons.download, size: 32, color: page),
      padding: EdgeInsets.symmetric(horizontal: 20, vertical: 18),
      borderRadius: 8,
      dismissDirection: DismissDirection.horizontal,
      duration: Duration(seconds: 5),
  ...
  static GetSnackBar ErrorSnackBar({String title = 'Error', String ? message}) {
    ...
    return GetSnackBar(
      titleText: Text(title.tr, style: Get.textTheme.headline6!.merge(TextStyle(color: page))),
      messageText: Text(message!.substring(0, min(message.length, 700)), style: Get.textTheme.caption!.merge(TextStyle(color: page))),
      snackPosition: SnackPosition.BOTTOM,
      margin: EdgeInsets.all(20),
      backgroundColor: Colors.redAccent,
      icon: Icon(Icons.remove_circle_outline, size: 32, color: page),
      padding: EdgeInsets.symmetric(horizontal: 20, vertical: 18),
      borderRadius: 8,
      duration: Duration(seconds: 5),
    );
  ...
  static InputDecoration getInputDecoration({String hintText = '', String? errorText, IconData ?iconData, Widget ?suffixIcon, Widget ?suffix}) {
    return InputDecoration(
      ...
      prefixIcon: iconData != null ? Icon(iconData, color: Colors.grey).marginOnly(right: 14) : SizedBox(),
