...
import 'package:service/features/common/settings_service.dart';
...
class MapsUtil {
  ...
  static Future<Marker> getMarker({/*required Address address,*/ String id = '', String description = ''}) async {
