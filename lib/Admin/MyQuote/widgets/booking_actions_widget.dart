...
import 'package:service/Admin/MyQuote/widgets/phone_verification_bottom_sheet_widget.dart';
...
class BookingActionsWidget extends GetView<ViewQuoteController> {
  final String title;

  BookingActionsWidget(this.title);
