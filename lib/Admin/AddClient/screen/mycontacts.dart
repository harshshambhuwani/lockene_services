...
class MyContactView extends StatefulWidget {
  ...
  List<String>? newStringContact;
    MyContactView({Key? key, this.contactList, this.newStringContact}) : super(key: key);
          ...
          children: [
            ...
            Expanded(
              child: ListView.builder(
                shrinkWrap: true,
                itemCount:widget.newStringContact?.length,
                itemBuilder: (BuildContext context, int index){
                  //Contact  contact = contacts[index];
                  return ListTile(
                    title: Text(widget.newStringContact?[index].toString() ?? ""),
                    subtitle: Text(widget.newStringContact?[index].toString() ?? ""),
