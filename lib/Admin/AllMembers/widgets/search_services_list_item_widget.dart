...
class SearchServicesListItemWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        // Get.toNamed(Routes.E_SERVICE, arguments: {'eService':"2"/* _service*/, 'heroTag': 'search_list_item'});
      },
      child: Container(
            ...
            Expanded(
              child: Wrap(
                ...
                children: <Widget>[
                    ...
                    children: [
                      Wrap(
                        ...
                        children: [
                            ...
                            child: Chip(
                              ...
                              label: Row(
                                ...
                                children: <Widget>[
                                  ...
                                  Text(/*_service.rate.toString()*/"202", style: Get.textTheme.bodyText2!.merge(TextStyle(color: Get.theme.colorScheme.secondary, height: 1.4))),
                                ],
                              ),
                          ...
                          Text(
                            "From (%s)".trArgs([/*_service.totalReviews.toString()*/"222"]),
                    ...
                    children: [
                      ...
                      Flexible(
                        child: Text(
                          ...
                          /*_service.eProvider!.firstAddress!*/"sxx",
                          maxLines: 1,
                          overflow: TextOverflow.fade,
                          softWrap: false,
                          style: Get.textTheme.bodyText1,
                  ...
                  Wrap(
                    spacing: 5,
                    children: List.generate(/*_service.categories!.length*/10, (index) {
                      return Container(
                        padding: EdgeInsets.symmetric(horizontal: 10, vertical: 4),
                        child: Text(/*_service.categories!.elementAt(index).name!*/"Rajat", style: Get.textTheme.caption!.merge(TextStyle(fontSize: 10))),
                        decoration: BoxDecoration(
